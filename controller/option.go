...
func GetOptions(c *gin.Context) {
	...
	for k, v := range common.OptionMap {
		...
		// Values that embed credentials (user:pass@host URLs, DSNs) are
		// sensitive regardless of how the option is named.
		if parsed, err := url.Parse(value); err == nil && parsed.User != nil && parsed.User.String() != "" {
			continue
		}
