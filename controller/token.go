...
func RotateToken(c *gin.Context) {
	...
	if err != nil {
		common.ApiErrorI18n(c, i18n.MsgTokenGenerateFailed)
		common.SysLog("failed to generate replacement token key: " + err.Error())
		return
	}
	...
	common.ApiSuccess(c, tokenCredentialResponse{
...
func UpdateToken(c *gin.Context) {
	...
	if token.Status == common.TokenStatusEnabled {
		if cleanToken.IsKeyInvalidated() {
...
func TokenKeyRotateTarget(id int) string {
