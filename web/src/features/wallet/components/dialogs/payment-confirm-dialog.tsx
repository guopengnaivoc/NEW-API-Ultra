...
export function PaymentConfirmDialog({
  ...
  const topupAmount = confirmation?.topupAmount ?? 0
  const paymentAmount = confirmation?.paymentAmount ?? 0
  const paymentMethod = confirmation?.paymentMethod
  const discountRate = confirmation?.discountRate ?? DEFAULT_DISCOUNT_RATE
  const usdExchangeRate = confirmation?.usdExchangeRate ?? 1
