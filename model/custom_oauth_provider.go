...
type CustomOAuthProvider struct {
	...
	ClientSecret          string `json:"-" gorm:"-"`                                                     // Decrypted OAuth client secret (not returned to frontend)
	EncryptedClientSecret string `json:"-" gorm:"column:client_secret;type:text"`                        // Versioned encrypted OAuth client secret
...
func (provider *CustomOAuthProvider) BeforeSave(_ *gorm.DB) error {
	...
	provider.EncryptedClientSecret = stored
	return nil
}
