...
const (
	...
	DefaultUserSessionIdleTimeoutSeconds    = 7 * 24 * 60 * 60
...
// BatchUpdateEnabled is retained for API and test compatibility. The lossy
// in-memory accounting mode is no longer enabled by the application.
