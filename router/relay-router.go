...
var relaySystemPerformanceCheck = middleware.SystemPerformanceCheck
...
func SetRelayRouter(router *gin.Engine) {
	...
	playgroundRouter.Use(relaySystemPerformanceCheck())
	...
	relayV1Router.Use(relaySystemPerformanceCheck())
	...
	relaySunoRouter.Use(relaySystemPerformanceCheck())
	...
	relayGeminiRouter.Use(relaySystemPerformanceCheck())
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	relayMjRouter.GET("/image/:id", middleware.TokenAuth(), relaySystemPerformanceCheck(), relay.RelayMidjourneyImage)
	relayMjRouter.Use(middleware.TokenAuth(), relaySystemPerformanceCheck(), middleware.Distribute())
	{
