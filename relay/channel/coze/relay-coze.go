...
const cozePollInterval = time.Second
const cozePollTimeout = 10 * time.Minute
...
func checkIfChatComplete(a *Adaptor, c *gin.Context, info *relaycommon.RelayInfo, requestCtx context.Context) (error, bool) {
...
func getChatDetail(a *Adaptor, c *gin.Context, info *relaycommon.RelayInfo, requestCtx context.Context) (*http.Response, error) {
