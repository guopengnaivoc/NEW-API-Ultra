...
func TestInitUserSessionSettingsUsesPositiveFallbacksAndClampsWindow(t *testing.T) {
	...
	previousIdleTimeout := UserSessionIdleTimeoutSeconds
	...
	t.Cleanup(func() {
		...
		UserSessionIdleTimeoutSeconds = previousIdleTimeout
	...
	t.Setenv("USER_SESSION_IDLE_TIMEOUT_SECONDS", "0")
	...
	t.Setenv("USER_SESSION_IDLE_TIMEOUT_SECONDS", "43200")
	...
	assert.Equal(t, int64(12*60*60), UserSessionIdleTimeoutSeconds)
