...
func GetResponseBody(method, url string, channel *model.Channel, headers http.Header) ([]byte, error) {
	return getResponseBodyWithContext(
		context.Background(),
		method,
		url,
		channel,
...
func getResponseBodyWithContext(
	ctx context.Context,
	method string,
	url string,
	...
	req, err := newChannelManagementRequest(ctx, method, url)
	if err != nil {
		return nil, err
	}
	for k := range headers {
	...
	return readChannelManagementResponse(
		client,
		req,
		channelBalanceResponseMaxBytes,
	)
}
...
func updateChannelBalanceWithContext(
	ctx context.Context,
	channel *model.Channel,
) (float64, error) {
...
func UpdateChannelBalance(c *gin.Context) {
	...
	balance, err := updateChannelBalanceWithContext(c.Request.Context(), channel)
	if err != nil {
		common.ApiError(c, err)
		return
	}
...
func updateAllChannelsBalanceWithContext(ctx context.Context) error {
	...
	for _, channel := range channels {
		...
		//	continue
		//}
		balance, err := updateChannelBalanceWithContext(ctx, channel)
		if err != nil {
			continue
		} else {
...
func UpdateAllChannelsBalance(c *gin.Context) {
	// TODO: make it async
	err := updateAllChannelsBalanceWithContext(c.Request.Context())
	if err != nil {
		common.ApiError(c, err)
		return
	}
