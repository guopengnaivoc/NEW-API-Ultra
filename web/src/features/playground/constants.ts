...
// Storage keys
// All persisted playground keys MUST start with this prefix so that
// clearPlaygroundStorage can remove every playground record (including
// per-user namespaced variants and legacy un-namespaced keys) on sign-out.
export const PLAYGROUND_STORAGE_KEY_PREFIX = 'playground_'
