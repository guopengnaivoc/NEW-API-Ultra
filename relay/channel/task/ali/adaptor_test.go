...
func TestConvertToAliRequestRejectsInvalidMetadataDuration(t *testing.T) {
	adaptor := &TaskAdaptor{}
	req := relaycommon.TaskSubmitReq{
		Model:    "wan2.6-i2v",
		Prompt:   "test",
...
func TestAliTaskAdaptorUsesSameDurationForRequestAndBilling(t *testing.T) {
	...
	require.Equal(t, 12, aliReq.Parameters.Duration)
	require.Equal(t, float64(aliReq.Parameters.Duration), ratios["seconds"])
}
