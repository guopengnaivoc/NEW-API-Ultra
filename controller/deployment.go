...
func getIoClient(c *gin.Context) (*ionet.Client, bool) {
	...
	return ionet.NewClient(apiKey).WithContext(c.Request.Context()), true
}
...
func getIoEnterpriseClient(c *gin.Context) (*ionet.Client, bool) {
	...
	return ionet.NewEnterpriseClient(apiKey).WithContext(c.Request.Context()), true
}
...
func TestIoNetConnection(c *gin.Context) {
	...
	client := ionet.NewEnterpriseClient(apiKey).WithContext(c.Request.Context())
