...
func OpenaiTTSHandler(c *gin.Context, resp *http.Response, info *relaycommon.RelayInfo) *dto.Usage {
	...
	if info.IsStream {
		service.CopyUpstreamResponseHeaders(c, resp.Header, service.UpstreamHeaderPolicyRelay)
	...
	service.CopyUpstreamResponseHeaders(c, resp.Header, service.UpstreamHeaderPolicyMedia)
