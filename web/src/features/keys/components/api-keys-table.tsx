...
export function ApiKeysTable() {
  ...
  const {
    ...
    onCompositionStart: onTokenFilterCompositionStart,
    onCompositionEnd: onTokenFilterCompositionEnd,
    resetInput: resetTokenFilterInput,
  } = useDebouncedColumnFilter({
    columnFilters,
  ...
  return (
    <DataTablePage
      ...
      toolbarProps={{
        ...
        normalizeSearchValue: normalizeGlobalFilter,
        onReset: resetTokenFilterInput,
        additionalSearch: (
          <Input
