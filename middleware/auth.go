...
func authHelper(c *gin.Context, minRole int) {
	...
	if useAccessToken && minRole > common.RoleCommonUser {
...
func writeDashboardAuthError(c *gin.Context, err error) {
	...
	if errors.Is(err, service.ErrAuthTokenInvalid) ||
		errors.Is(err, model.ErrDashboardAccessTokenInvalid) ||
		errors.Is(err, model.ErrDashboardAccessTokenExpired) ||
		errors.Is(err, model.ErrDashboardAccessTokenRevoked) {
